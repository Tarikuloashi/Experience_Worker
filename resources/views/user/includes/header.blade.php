        ...
        <div class="navbar-header" data-logobg="skin5">
            ...
            <a class="navbar-brand" href="{{url('/userHome')}}">
                ...
                <b class="logo-icon p-l-10">
                  ...
                  <h3> <i class="fab fa-servicestack"></i> Service Provider</h3>
            ...
            <ul class="navbar-nav float-right">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right user-dd animated">
                        ...
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="{{url('/logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="fa fa-power-off m-r-5 m-l-5"></i> Logoutt </a>
                        <div class="dropdown-divider"></div>
